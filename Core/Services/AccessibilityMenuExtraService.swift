...
private let menuExtrasLogger = Logger(subsystem: "com.sanebar.app", category: "AccessibilityMenuExtraService")
...
enum AccessibilityMenuExtraService {
    ...
    internal nonisolated static func shouldAcceptThirdPartyTopBarFallbackItem(
        ...
        if AccessibilityMenuBarScanningService.bundleIdentifierFallback(fromAXIdentifier: normalizedIdentifier) != nil {
            return true
        }
    ...
    nonisolated static func captureStatusItemReactionSnapshot(
        item: AXUIElement,
    ...
    nonisolated static func shownMenuPresence(
        item: AXUIElement,
        appElement: AXUIElement
    ) -> Bool? {
    ...
    nonisolated static func focusedWindowPresence(_ appElement: AXUIElement) -> Bool? {
        elementPresenceAttribute(kAXFocusedWindowAttribute as CFString, on: appElement)
    }

    nonisolated static func appWindowCount(_ appElement: AXUIElement) -> Int? {
        var value: CFTypeRef?
    ...
    nonisolated static func appWindowServerCount(_ appElement: AXUIElement) -> Int? {
        var pid: pid_t = 0
    ...
    nonisolated static func elementPresenceAttribute(_ attribute: CFString, on element: AXUIElement) -> Bool? {
        var value: CFTypeRef?
    ...
    nonisolated static func boolAttribute(_ attribute: CFString, on element: AXUIElement) -> Bool? {
        var value: CFTypeRef?
        let error = AXUIElementCopyAttributeValue(element, attribute, &value)
        switch error {
        case .success:
    ...
    nonisolated static func menuBarItemPosition(bundleID: String, menuExtraId: String? = nil, statusItemIndex: Int? = nil) -> CGPoint? {
    ...
    nonisolated static func getMenuBarIconFrame(
        bundleID: String,
    ...
    nonisolated static func frameForStatusItem(_ item: AXUIElement) -> CGRect? {
    ...
    nonisolated static func resolvedTargetStatusItem(
    ...
    nonisolated static func actionableMoveResolutionSafety(
        bundleID: String,
        menuExtraId: String? = nil,
        statusItemIndex: Int? = nil,
        preferredCenterX: CGFloat? = nil
    ...
    private nonisolated static func positionalActionableMoveResolutionSafety(
        from items: [AXUIElement],
        bundleID: String,
        statusItemIndex: Int?,
        preferredCenterX: CGFloat?
